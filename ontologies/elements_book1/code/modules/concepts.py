...
def add_definition_concepts(kg: rdflib.Graph,
    ...
    for concept, concept_data in concepts.items():
        ...
        kg.add((concept_iri, is_defined_in, utils.create_iri("Document: Elements Book 1", namespace="https://www.foom.com/core")))
        kg.add((utils.create_iri("Document: Elements Book 1", namespace="https://www.foom.com/core"), contains_definition_of, concept_iri))
        for subconcept in concept_data["subconcepts"]:
            subconcept_label = subconcept.replace("~", "").replace(",", "").strip()
            subconcept_iri = utils.create_iri(f"Concept: {subconcept_label}", namespace="https://www.foom.com/core")
        ...
        definition_iri = utils.create_iri(definition_label, namespace="https://www.foom.com/core")
...
def add_definition(kg: rdflib.Graph,
    ...
    kg.add((definition_iri, is_in, utils.create_iri("Document: Elements Book 1", namespace="https://www.foom.com/core")))
